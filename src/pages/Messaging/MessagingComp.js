...
const MessagingComp = ({ Conversation, currentUser, query="" ,Messages}) => {
                ...
                {user?.userName?.toLowerCase()?.includes(query?.toLowerCase()) ?<Box className={classes.listitem2}>
                    ...
                    <Box className={classes.widthright}>
                        <Box>
                            ...
                            {/* <Typography className={classes.para2} color="#949494">{ Messages?Messages?.slice(-1)[0]?.text:""}</Typography> */}
                        </Box>
                        <Box textAlign="right">
