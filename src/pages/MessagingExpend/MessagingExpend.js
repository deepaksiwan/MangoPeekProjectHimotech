...
//             //         console.log(
//             //             'sdsajndas', result.push(item?.members[0]?.senderId)
//             //         )
//             //         return item
...
//                                                         {
//                                                             conversations.filter((c, v) =>
            
//                                                                 (c?.members[0]?.senderId?._id == userData?._id?c?.members[0]?.receiverId?.userName.toLowerCase().includes(userSearch?.toLowerCase()):c?.members[0]?.senderId?.userName.toLowerCase().includes(userSearch?.toLowerCase()))

//                                                             ).map((c, v) => {
//                                                                 {console.log("c", c)}
//                                                                 return (
//                                                                     <Box onClick={() => setCurrentChat(c?.members[0]?.senderId)}>
//                                                                         <MessagingComp Conversation={c} currentUser={userData} Messages={messages} CurrentChat={currentChat}/>
//                                                                     </Box>
//                                                                 )
//                                                             })
...
//                                                                 <Typography className={classes.Chatuser} component="img" src={currentChat?.profilePic}></Typography>
//                                                             </Box>
//                                                             <Box className={classes.widthright}>
//                                                                 <Box>
//                                                                     <Typography variant="h6" color="#949494">{currentChat? currentChat?.userName:""}</Typography>
...
//                                 <NFTMsgExp onLineUsers={onlineUsers} currentUser={userData} ChatUserId={currentChat} />
//                             </Box>
//                         </Grid>
//                     </Grid>
